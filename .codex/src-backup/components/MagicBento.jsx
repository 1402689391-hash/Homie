...
export default function MagicBento({ children, className = "", enableBorderGlow = true, enableStars = false, enableSpotlight = false, enableTilt = false, enableMagnetism = false, clickEffect = false, glowColor = DEFAULT_GLOW_COLOR }) {
